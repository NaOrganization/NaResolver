...
namespace Template
{
	...
	struct NormalClass
	{
		...
		inline static NaResolver::Class ClassInfoCache;
	...
	struct StaticMemberField
	{
		...
		inline static VmGeneralType::Field FieldInfoCache;
	...
	struct MemberMethod
	{
		...
		inline static void* MethodAddressCache;
...
void* VmGeneralType::Method::GetSignatureForMono() const
{
...
void* VmGeneralType::Class::VTable() const
{
...
{
	static Template::VmMethodInvoker<wchar_t*, void*> string_chars = TEXT("mono_string_chars");
...
{
	static Template::VmMethodInvoker<void*, void*, void*, uint32_t> array_new = TEXT("mono_array_new");
